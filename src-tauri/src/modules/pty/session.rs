...
const AGENT_EVENT: &str = "backsteros:agent-signal";
...
pub fn spawn(
    ...
    let cmd = shell_init::build_command(cwd, blocks)?;
    ...
    let reader_thread = thread::Builder::new()
        .name("backsteros-pty-reader".into())
        .spawn(move || {
    ...
    thread::Builder::new()
        .name("backsteros-pty-flusher".into())
        .spawn(move || {
    ...
    let done_e = done;
    thread::Builder::new()
        .name("backsteros-pty-waiter".into())
        .spawn(move || {
