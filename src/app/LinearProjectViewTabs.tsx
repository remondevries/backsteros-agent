...
function LinearProjectIssuesSettingsIcon() {
  return (
...
export function LinearProjectViewTabs({
  ...
  const { watcherActive, pollIntervalMs, animationKey } = useLinearProjectWatcherPollProgress(
    issuesWatcherProjectId,
        ...
        <div className="linear-project-view-tabs-controls">
          ...
          {showIssuesSettingsButton ? (
            <button
              ...
              aria-label={watcherActive ? "Issue watcher active" : "Issue settings"}
            ...
            >
              {watcherActive ? (
                ...
                <LinearProjectIssuesSettingsIcon />
              )}
            </button>
          ) : null}
        </div>
