...
export const GOOD_MORNING_AUTOMATION: AutomationDefinition = {
  ...
  steps: [
    ...
    },
    {
      kind: "followUpPrompt",
      id: "wake",
      prompt: GOOD_MORNING_WAKE_PROMPT,
      composerQuickActionId: GOOD_MORNING_ACTION_ID,
      answerQuickActionId: GOOD_MORNING_WAKE_ACTION_ID,
      hasPromptForRun: hasGoodMorningWakePromptForRun,
      pacingKey: (runId) => `good-morning-wake-${runId}`,
    },
    {
      kind: "followUpPrompt",
      id: "feel",
